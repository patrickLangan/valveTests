...
int main (int argc, char **argv)
{
	...
	const float Cvi[11] = {0.0188, 0, 0.0504, 0, 0, 0.125, 0, 0, 0.195, 0.216, 0.226};
	const float Xti[11] = {0.7850055, 0, 0.761162, 0, 0, 0.6264885, 0, 0, 0.582306, 0.573261, 0.560641};
